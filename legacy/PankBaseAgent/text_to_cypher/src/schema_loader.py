...
def get_simplified_schema() -> Dict[str, Any]:
    ...
    if _cached_simple is None:
        ...
        Notes = {
            ...
            "part_of_QTL_signal": (
                "part_of_QTL_signal connects SNPs to genes showing variant-expression associations. "
                "Use pattern: (s:snp)-[:part_of_QTL_signal]->(g:gene). Commonly used in eQTL and fine-mapping analyses."
            )
        }
...
def get_minimal_schema_for_llm() -> str:
    ...
    if _cached_minimal is None:
        ...
        edge_filter_props = {
            ...
            "part_of_QTL_signal": ["pip", "slope", "nominal_p"],
