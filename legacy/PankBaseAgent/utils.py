...
def _get_text2cypher_agent():
    ...
    if _TEXT2CYPHER_AGENT is None:
        os.environ['NEO4J_SCHEMA_PATH'] = '/nfs/turbo/umms-drjieliu/usr/rickyhan/rllm/examples/PanKLLM_RL_post-training/legacy/PankBaseAgent/text_to_cypher/data/input/kg_schema.json'
